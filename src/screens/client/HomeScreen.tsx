...
const sosStyles = StyleSheet.create({
  ...
  sendBtn:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing[2], width: '100%', paddingVertical: spacing[4], backgroundColor: colors.dangerDot, borderRadius: radius.full, shadowColor: colors.dangerDot, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 10, elevation: 6 },
