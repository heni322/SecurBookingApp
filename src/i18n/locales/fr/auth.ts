...
const auth: AuthNS = {
  ...
  register: {
    ...
    account_type: 'TYPE DE COMPTE', individual: 'Particulier', individual_sub: 'Usage personnel', company: 'Entreprise', company_sub: 'Facturation B2B', partner: 'Partenaire', partner_sub: 'Société de sécurité',
