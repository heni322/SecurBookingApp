...
const quote: QuoteNS = {
  ...
  empty_title: 'Quote not found',
  empty_subtitle: 'The quote has not yet been generated for this mission.',

  pending_banner:
    'Check the pricing details and accept the quote to proceed to payment.',

  payment_method: 'Payment method',
  card: 'Bank card',
  sepa: 'SEPA transfer',
  offline: 'Bank wire / Cheque',

  accept: 'Accept quote',
  accepting: 'Accepting...',

  pay_card: 'Pay by card',
  pay_sepa: 'Pay by SEPA',
  ...
  error_accept: 'Unable to accept the quote',
  error_pay:    'Unable to initiate payment',
  ...
  offline_note:
    "Bank wire or cheque. Your mission will be confirmed after validation by our team (1-3 business days).",

  breakdown_title: 'Price breakdown',

  // ── Service line items (per agent type) ────────────────────────────────────
