...
const missions: MissionsNS = {
  ...
  success: {
    ...
    timeout_subtitle: 'For SEPA payments, confirmation can take 1 to 2 business days. You will receive a notification once your mission is confirmed.',
    timeout_info: 'Your mission will be automatically published to agents upon payment receipt. No further action required.',
